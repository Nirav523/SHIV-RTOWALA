...
const Navbar: React.FC<NavbarProps> = ({ isScrolled }) => {
  ...
  return (
    ...
    <div className={`fixed inset-0 z-[100] bg-[#050508]/95 backdrop-blur-2xl transition-transform duration-500 ${isMobileMenuOpen ? 'translate-y-0' : '-translate-y-full'} flex flex-col items-center justify-start pt-64 md:hidden`}>
      <button 
